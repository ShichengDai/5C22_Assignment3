...
input_image = cv2.imread('images/input_training_highres/GT04.png');
trimap_image = cv2.imread('images/trimap_training_highres/Trimap1/GT04.png');
...
# write output
cv2.imwrite('laplacian_alpha.png', alpha * 255)
